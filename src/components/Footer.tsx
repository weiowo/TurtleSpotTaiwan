...
export default function Footer() {
  return (
    <div className="flex flex-col gap-10 lg:flex-row w-full h-[392px] lg:h-[380px] justify-between px-6 lg:px-[80px] py-[80px] lg:py-12 bg-[#00CAD7] custom-font-bold leading-[1.6] tracking-[0.02rem]">
      ...
      <div className="flex items-end gap-10">
        <div className="flex flex-col gap-1 lg:gap-2 w-full lg:w-[220px]">
